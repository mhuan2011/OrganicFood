...
//			return "frontend/shoppingCart";
		...
		String nd = "Thông tin đơn hàng:" + "<br>" + "Mã số đơn đặt hàng: " + dh.getMasoddh().toString() + "<br>"
				+ "Tên khách hàng: " + dh.getKhachhang().getPhone() + "<br>" + "Ngày đặt hàng: " + strDate + "<br>"
				+ "Tên nhân viên: " + dh.getNhanvien().getId() + "<br>" + "Tên đơn vị vận chuyển: "
				+ dh.getDvvc().getMadv() + "<br>" + "Trạng thái đơn hàng: " + dh.getTrangthai() + "<br>"
				+ "Mã khuyến mãi được áp dụng: " + dh.getMakm() + "<br>";
	...
	public Map<String, String> getTenDV() {
		...
		for (int i = 0; i < list.size(); i++) {
			tt.put(list0.get(i).toString(), list.get(i).toString() + " Giá:" + list1.get(i).toString() + " Thời gian:"
