	        ...
	        <div class="card1 col-md-3 mt-100">
	            <div class="card-content">
	                <div class="card-body1 p-0">
	                    ...
	                    <div class="card-title mt-4"> Nguyễn Minh Huấn<br /> <small>N18DCCN074</small> </div>
	                    <div class="card-subtitle">
	                        <p> <small class="text-muted"> Đây là những gì tôi mong đợi ở một đội ngũ chuyên gia. Họ là đội tốt nhất từ ​​trước đến nay! </small> </p>
	                    </div>
	                    <div>
	        ...
	        <div class="card1 col-md-3 mt-100">
	            <div class="card-content">
	                <div class="card-body1 p-0">
	                    ...
	                    <div class="card-title mt-4"> Nguyễn Hữu Nhân<br /> <small>N18DCCN137</small> </div>
	                    <div class="card-subtitle">
	                        <p> <small class="text-muted"> Tôi thực sự rất thích làm việc với họ, họ là một nhóm chuyên gia và họ biết họ đang làm gì! </small> </p>
	                    </div>
	                    <div>
	        ...
	        <div class="card1 col-md-3 mt-100">
	            <div class="card-content">
	                <div class="card-body1 p-0">
	                    ...
	                    <div class="card-title mt-4"> Trương Nguyễn Trung Hiền<br /> <small>N18DCCN062</small> </div>
	                    <div class="card-subtitle">
	                        <p> <small class="text-muted"> Các thành viên có trách nhiệm rất cụ thể và các ý tưởng của họ rất tuyệt vời và có chất riêng! </small> </p>
	                    </div>
